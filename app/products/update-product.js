jQuery(function($){
    ...
    $(document).on('click', '.update-product-button', function(){
        ...
        $.getJSON("http://localhost:8888/product/read_one.php?id=" + id, function(data){
            ...
            $.getJSON("http://localhost:8888/category/read.php", function(data){
...
// изменим title страницы
    ...
    $(document).on('submit', '#update-product-form', function(){
        ...
        $.ajax({
            url: "http://localhost:8888/product/update.php",
            type : "POST",
